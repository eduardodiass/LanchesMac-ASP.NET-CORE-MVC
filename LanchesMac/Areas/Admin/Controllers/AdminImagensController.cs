...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public AdminImagensController(IWebHostEnvironment hostingEnviromnment, IOptions<ConfigurationImagens> myConfiguration)
        {
            _hostingEnvironment = hostingEnviromnment;
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            {
                if(formFile.FileName.Contains(".jpg")|| formFile.FileName.Contains(".gif")|| formFile.FileName.Contains(".png")|| formFile.FileName.Contains(".webp"))
                {
        ...
        public IActionResult DeleteFile(string fname)
        {
            ...
            if ((System.IO.File.Exists(_imagemDeleta))) 
            {
                ...
                ViewData["Deletado"] = $"sArquivo(s){_imagemDeleta} Deletado com sucesso";
            }
            return View("index");
        }
